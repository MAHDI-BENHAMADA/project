...
<div id="push"></div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCpLkx1uRpSIyrXLh3sXXdoFWRUU_n8lZI&libraries=places&callback=load"
        async defer></script> 
    <?php 
    ...
    function load() {
      var map = new google.maps.Map(document.getElementById("map"), {
        center: new google.maps.LatLng(19.0469653, 72.8880971),
        zoom: 6,
        mapTypeId: 'roadmap'
      });
